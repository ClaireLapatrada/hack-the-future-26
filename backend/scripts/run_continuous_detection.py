...
# Backend root = parent of scripts/ ; project root is one level above
...
try:
    ...
    load_dotenv(_BACKEND_ROOT / "agents" / "orchestrator_agent" / ".env")
except ImportError:
    pass
...
from backend.tools.reasoning_log import append_entry, flush, clear as clear_reasoning_log
...
def _load_agent():
    ...
    agent_path = _BACKEND_ROOT / "agents" / "orchestrator_agent" / agent_file
